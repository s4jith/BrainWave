            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                {assignment && (
                    <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-4 flex items-center gap-3 flex-wrap">
                        ...
                        <button
                            onClick={loadAll}
                            className="ml-auto px-3 py-1.5 text-sm text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition flex items-center gap-1"
                        >
